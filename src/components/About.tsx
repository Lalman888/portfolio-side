    ...
    <div>
      ...
      <div className="max-w-4xl">
        <Paragraph className="mt-4">
          Hey there, I&apos;m Lalman Thakur - a full-stack developer based in
          Noida, Uttar Pradesh, specializing in creating responsive and
        ...
        <Paragraph className="mt-4">
          Over the past 2 years, I&apos;ve built a strong foundation in React,
          TypeScript, Golang, AWS, MongoDB, and cloud platforms like GCP and
          AWS. I&apos;ve worked with companies like Evolvetech Solutions, where
          I developed user-friendly dashboards, and Backstage Supporters, where
          I launched e-commerce websites. Currently, I am working part-time
          remotely with Mastermind Marketing, Inc. in Houston, USA.
        </Paragraph>
        <Paragraph className="mt-4">
          I&apos;m driven by the belief that great design and functionality go
          hand in hand, ensuring that every project I work on performs well and
          looks stunning.
        </Paragraph>
        <Paragraph className="mt-4">
